...
[RFP-006](./RFP-006-token-launchpad.md)) or investor round on LEZ
...
used by Streamflow, Sablier, and Team.Finance alike. Burning
...
3. The mini-app must display a pre-claim confirmation summary:
...
4. When using the private account path, the mini-app must display
...
6. Failed claims must return clear, actionable error messages —
