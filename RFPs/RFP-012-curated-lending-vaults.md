...
All other platform primitives required by this RFP (including LP-0013
token transfer authorities and an oracle provider) are hard blockers
for RFP-008 and will therefore be resolved before this RFP opens.
LP-0015 (general cross-program calls), once a blocker, is delivered. See
